...
const SEED_SOURCES = [
  ...
  { name: 'GlobeNewsWire', source_key: 'globenewswire', category: 'pr_wires', type: 'free', cost: '$0', status: 'not_connected', description: 'Global press releases. Phase 2.' },
  { name: 'Accesswire', source_key: 'accesswire', category: 'pr_wires', type: 'free', cost: '$0', status: 'not_connected', description: 'Popular with early-stage startups. Phase 2.' },
  ...
  { name: 'IEEE Spectrum Robotics', source_key: 'ieee_spectrum', category: 'news', type: 'free', cost: '$0', status: 'not_connected', description: 'Technical robotics coverage. Phase 2.' },
  { name: 'Import AI Newsletter', source_key: 'import_ai', category: 'news', type: 'free', cost: '$0', status: 'not_connected', description: 'Jack Clark\'s AI research newsletter. Phase 2.' },
  ...
  { name: 'Hugging Face Datasets', source_key: 'huggingface', category: 'datasets', type: 'free', cost: '$0', status: 'not_connected', description: 'New robotics datasets. Track uploading labs. Phase 2.' },
  { name: 'GitHub Trending', source_key: 'github', category: 'datasets', type: 'free', cost: '$0', status: 'not_connected', description: 'Trending robotics repos. Phase 2.' },
  { name: 'Reddit Monitoring', source_key: 'reddit', category: 'social', type: 'free', cost: '$0', status: 'not_connected', description: 'r/robotics, r/MachineLearning threads about data. Phase 2.' },
  ...
  { name: 'NSF Award Search', source_key: 'nsf', category: 'grants', type: 'free', cost: '$0', status: 'not_connected', description: 'Federal grants for robotics research. Phase 2.' },
