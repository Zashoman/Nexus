...
export default function DroneItemCard({ item, isSelected, onClick, currentRating, onRate }: DroneItemCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2">
        <span className="text-[10px] font-mono text-[#5A6A7A] truncate">{item.source_name}</span>
        <RatingButtons
          itemId={item.id}
